	...
	m.Register(func(app core.App) error {
		jsonData := `[
			...
			},
			{
				...
				"id": "pbc_1201014562",
				"indexes": [
					"CREATE INDEX ` + "`" + `idx_event_signups_event` + "`" + ` ON ` + "`" + `event_signups` + "`" + ` (` + "`" + `event` + "`" + `)",
					"CREATE INDEX ` + "`" + `idx_event_signups_user` + "`" + ` ON ` + "`" + `event_signups` + "`" + ` (` + "`" + `user` + "`" + `)"
				],
				"listRule": "",
				"name": "event_signups",
				"system": false,
